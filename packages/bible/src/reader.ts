...
export interface RawBibleJSON {
  ...
  language: string;
  testaments: {
    [testament: string]: { [book: string]: { [chapter: string]: string[] } };
  };
}
...
export async function loadBibleData(
  ...
  try {
    ...
    switch (versionId) {
      case 'fr_lsg': {
        const mod = await import('../../../.agents/data/json/fr_lsg.json', {
          with: { type: 'json' },
        });
      ...
      case 'fr_ost': {
        const mod = await import('../../../.agents/data/json/fr_ost.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      case 'fr_mar': {
        const mod = await import('../../../.agents/data/json/fr_mar.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      case 'fr_apee': {
        const mod = await import('../../../.agents/data/json/fr_apee.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      case 'en_kjv': {
        const mod = await import('../../../.agents/data/json/en_kjv.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      case 'en_bsb': {
        const mod = await import('../../../.agents/data/json/en_bsb.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      case 'en_web': {
        const mod = await import('../../../.agents/data/json/en_web.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      case 'en_ylt': {
        const mod = await import('../../../.agents/data/json/en_ylt.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      case 'en_bbe': {
        const mod = await import('../../../.agents/data/json/en_bbe.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      case 'en_asv': {
        const mod = await import('../../../.agents/data/json/en_asv.json', {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
      ...
      default: {
        const mod = await import(`../../../.agents/data/json/${versionId}.json`, {
          with: { type: 'json' },
        });
        data = (mod.default || mod) as unknown as RawBibleJSON;
        break;
...
export async function getChapterFromData(
  ...
  const bookData =
    ...
    testamentBooks[
      Object.keys(testamentBooks).find(
        k => k.toUpperCase().replace(/\s+/g, '_') === normalizedId,
      ) || ''
    ];
  ...
  return { version_id: versionId, book_id: canonicalMeta.bookId, chapter, verses };
}
